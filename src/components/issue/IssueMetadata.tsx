  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        ...
        <span
          className={getScoreClass(analysis.doability_score)}
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <span style={{ color: 'var(--text)' }}>
          {complexityLabel(analysis.complexity)} ({analysis.complexity}/5)
        </span>
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <span style={{ color: 'var(--text)' }}>
          {friendlinessLabel(analysis.newcomer_friendliness)} ({analysis.newcomer_friendliness}/5)
        </span>
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <span
          style={{
            color: analysis.is_actionable_code_change ? 'var(--status-success)' : 'var(--text-dim)',
          }}
        >
