      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <Button variant="ghost" size="sm" onClick={() => setScreen('input')}>
              <ArrowLeft size={16} />
              Back
            </Button>
            <h1
        ...
        {isHistoryLoading ? (
          ...
          >
            ...
            <div>{searchQuery ? 'No repositories match your search' : 'No history yet'}</div>
            {!searchQuery && (
              <Button variant="primary" size="sm" onClick={() => setScreen('input')}>
              ...
              {filteredHistory.map((entry) => (
                <div
                  ...
                  style={{
                    padding: '16px',
                    background:
                      selectedEntry === entry.key ? 'var(--bg-tertiary)' : 'var(--bg-secondary)',
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  ...
                  >
                    ...
                    <StatCard
                      ...
                      value={formatActivityRate(
                        selectedData.metadata.issuesActivity.newIssuesPerDay,
                      )}
                      color={getActivityColor(selectedData.metadata.issuesActivity.newIssuesPerDay)}
                    />
                  </div>
                  ...
                  >
                    <div style={{ marginBottom: '8px' }}>
                      ...
                      <br />
                      {new Date(
                        selectedData.metadata.issuesActivity.lastIssueCreatedAt,
                      ).toLocaleDateString()}
                    </div>
                    <div>
                      ...
                      <br />
                      {new Date(
                        selectedData.metadata.commentsActivity.lastCommentCreatedAt,
                      ).toLocaleDateString()}
                    </div>
                  </div>
